    ...
    <div className="z-50">
      ...
      <div class="hidden mx-5 my-5 lg:mx-10 lg:my-5 lg:flex flex-wrap items-center justify-between gap-2 ">
        <Link
          ...
          className="hidden lg:block lg:text-3xl text-slate-700"
        >
        ...
        >
          ...
          <ul class="lg:flex gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
            ...
            <li class="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
              <Link
                href="javascript:void(0)"
                class="hover:text-[#007bff] text-slate-700 block font-semibold text-[18px]"
              >
                Contact Us
              </Link>
            </li>
        ...
        <div class="flex  lg:max-lg:ml-auto  lg:space-x-6 ">
          <button className="border rounded-full p-1 lg:p-2 lg:hover:p-[7px] bg-slate-700 text-white hover:bg-white hover:text-slate-700 hover:border-slate-700 hover:border-2">
            {" "}
            <FaShoppingBasket size={25} />
          </button>

          <button class="px-4 lg:py-1 rounded-md font-bold text-white border-2 border-slate-700 bg-slate-700 transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#007bff] hidden lg:block">
            Login
          </button>
          <button class="px-4 am:py-1  rounded-md font-bold text-white border-2 border-slate-700 bg-slate-700 transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#007bff] hidden lg:block">
            Sign up
          </button>
        </div>
      </div>
            ...
            <div className="relative bg-white w-1/2 min-w-[300px] h-full p-6 shadow-md overflow-auto">
              ...
              <ul className="space-y-3">
                ...
                <li className="border-b border-gray-300 py-3 px-3">
                  ...
                  >
                    Hotel{" "}
                    <span> {hotel ? <FaAngleUp /> : <FaAngleDown />}</span>
                  </Link>
                </li>
                {hotel && (
                  <div class="">
...
const FlyoutLink = ({ children, href, FlyoutContent }) => {
  ...
  return (
    ...
    >
      <Link
        to={href}
        className="relative flex items-center gap-1 text-slate-700 font-semibold hover:text-[#007bff] text-[18px]"
      >
        {children}{" "}
        <span>
          {" "}
...
const HotelContent = () => {
  return (
    <div className=" w-60 rounded-md bg-slate-800 p-6 shadow-xl flex flex-col text-[18px] gap-2 text-start">
      <Link
        to="/"
        className="text-white  text-[16px]  hover:underline hover:underline-offset-4 "
      >
